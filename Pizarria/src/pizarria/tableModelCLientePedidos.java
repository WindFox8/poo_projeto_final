 ...
 * @author joaow
 */
public class tableModelCLientePedidos extends AbstractTableModel{
    ...
    public tableModelCLientePedidos(){
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 3: return customer.getPedido().getEstado();//if column 2 (birthday)
            default : return null;
        }
    }
